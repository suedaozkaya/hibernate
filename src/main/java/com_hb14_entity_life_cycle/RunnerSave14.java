package com_hb14_entity_life_cycle;
...
public class RunnerSave14 {
	...
	public static void main(String[] args) {
		...
		//student1 save edildikten sonra persistent state'e geçiyor.

		student1.setName("Updated in persistent state");
		
		//detached yapınca yukarıdaki save metodunun yaptığı değişiklik de kalıcı olmuyor.
		session.evict(student1);
		
		//detached yapınca aşağıdaki set işe yaramıyor.
		//Çünkü artık persistent context tarafından detached edilmiş.
